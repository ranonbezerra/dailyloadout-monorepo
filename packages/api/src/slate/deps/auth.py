...
from slate.core.admin.captures_service import AdminCaptureService
from slate.core.admin.config_service import AdminConfigService
...
from slate.infrastructure.db.repositories.admin import (
